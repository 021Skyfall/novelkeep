...
> `docs/02_사용자_요구사항_정의서.md`를 기준으로 정리한 데이터 모델 기준안이다. 구현 중 변경이 있으면 영향 범위를 적고 이 문서와 코드를 함께 맞춘다.

| 바로가기 | |
|---|---|
| [1. 기준](#1-모델링-기준) | [2. ERD](#2-전체-erd) |
| [3. 엔티티](#3-엔티티별-역할) | [8. 삭제](#8-삭제-정책) |
| [10. 트랜잭션](#10-핵심-트랜잭션) | [11. 범위](#11-현재-확정한-범위) |
